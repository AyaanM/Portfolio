  ...
  return (
    <section id="about" className="section">
        ...
        <div className="container flex items-center gap-15">
          ...
          <div className="about-pics">
            <img src="Portfolio/images/talk.jpg" className="w-full -mb-10 z-2 ml-10 rounded-xl shadow-lg" />
            <img src="Portfolio/images/trail-bike.jpg" className="w-full -mb-5 rounded-xl shadow-lg" />
